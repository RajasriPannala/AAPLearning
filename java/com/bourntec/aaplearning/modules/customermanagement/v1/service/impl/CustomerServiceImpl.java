...
public class CustomerServiceImpl implements CustomerService {
	 ...
	 */
	@Override
	public CustomerResponseDTO findById(int custId) throws Exception {
	...
	public CustomerResponseDTO deleteById(Integer custId) {
		CustomerResponseDTO customerResponseDTO = new CustomerResponseDTO();
		if (customerRepository.existsById(custId) == true) {
	 ...
	 */
	@Override
	public CustomerResponseDTO updateById(Integer custId, CustomerRequestDTO customerRequestDTO) {
		CustomerResponseDTO CustomerResponseDTO = new CustomerResponseDTO();
		Optional<Customer> customerOptional = customerRepository.findById(custId);
		if (customerOptional.isPresent()) {
